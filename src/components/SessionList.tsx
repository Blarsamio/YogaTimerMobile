...
export const SessionList: React.FC<SessionListProps> = ({ sessions, onDelete, onStartSession }) => {
    ...
    >
      ...
      <View className="flex-row justify-between items-start mb-4">
        <View className="flex-1 mr-4">
          ...
          {item.description && (
            <Text className="text-sm opacity-70 leading-relaxed" style={{ color: textColor }}>
              {item.description}
            </Text>
          )}
        </View>
      ...
      <View className="flex-row justify-between items-center mb-4">
        <View className="flex-row items-center">
          ...
          <Text className="text-sm ml-2 font-ubuntu-medium" style={{ color: textColor }}>
      ...
      <View className="flex-row">
        ...
        >
          <View className="flex-row items-center">
            ...
            <Text className="font-ubuntu-medium ml-2" style={{ color: accentColor }}>
              View Details
            </Text>
          </View>
        </TouchableOpacity>
    ...
    <View className="flex-1 px-6 pt-6" style={{ backgroundColor }}>
      {sessions.length === 0 ? (
        <View className="flex-1 justify-center items-center">
          ...
          <Text className="text-lg font-zen text-center mt-4 mb-2" style={{ color: textColor }}>
            No sessions yet
          </Text>
          <Text className="text-sm text-center opacity-70" style={{ color: textColor }}>
